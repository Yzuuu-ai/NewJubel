...
const DashboardPembeli = () => {
  ...
  const fetchTransaksi = useCallback(async (showLoading = true) => {
    try {
      ...
      // Debug log untuk melihat data transaksi yang dimuat
      console.log('🔄 DashboardPembeli - Transaksi data loaded:', filteredTransaksi);
      if (filteredTransaksi.length > 0) {
        console.log('🔄 DashboardPembeli - First transaction:', filteredTransaksi[0]);
        console.log('🔄 DashboardPembeli - First transaction produk:', filteredTransaksi[0].produk);
        console.log('🔄 DashboardPembeli - First transaction gambar:', filteredTransaksi[0].produk?.gambar);
      }
            ...
            {transaksi.length === 0 ? (
              <div className="px-6 py-12 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">
                  {error ? 'Tidak dapat memuat transaksi' : 'Belum ada pembelian'}
                </h3>
                <p className="text-gray-600 mb-8 max-w-md mx-auto">
                  {error 
                    ? 'Terjadi masalah saat memuat data. Silakan coba lagi.' 
                    : 'Mulai berbelanja untuk melihat riwayat transaksi pembelian Anda di sini.'
                  }
                </p>
                <div className="space-y-3">
                  {error ? (
                    ...
                    <button
                      ...
                      className="inline-flex items-center px-8 py-4 border border-transparent text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 transition-colors shadow-lg"
                    >
              ...
              <div className="space-y-6">
                {transaksi.map((item) => (
                  <div key={item.id} className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div className="flex items-center space-x-3">
                          <div className="text-sm font-medium text-gray-900">
                            {item.produk?.namaGame || 'Game'} • #{item.kodeTransaksi || item.id}
                          </div>
                        </div>
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="text-right">
                            ...
                            <div className="text-xs text-gray-500">
                              ≈ Rp {item.produk?.harga?.toLocaleString('id-ID') || '0'}
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    {/* Content Card */}
                    <div className="p-6">
                      {/* Product Info dengan gambar yang lebih besar */}
                      <div className="flex items-start space-x-4 mb-6">
                        <div className="flex-shrink-0">
                          <img
                            src="https://res.cloudinary.com/dexbsjodh/image/upload/v1754061947/jubel-marketplace/product-1754061944175-725176783.jpg"
                            alt={item.produk?.judulProduk || 'Produk'}
                            className="w-24 h-24 rounded-lg border border-gray-200 shadow-sm object-cover"
                            onError={(e) => {
                      ...
                      <div className="mb-6">
                            ...
                            <div className="flex items-start">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-yellow-700">
                                  Anda memiliki waktu terbatas untuk menyelesaikan pembayaran melalui smart contract.
                                </p>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="flex items-start">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-blue-700">
                                  Dana telah ditahan dalam smart contract. Menunggu penjual mengirim data akun.
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        {item.status === 'DIKIRIM' && (
                          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                            <div className="flex items-start">
                              <DocumentTextIcon className="h-5 w-5 text-purple-600 mt-0.5 mr-3" />
                              <div>
                                <h4 className="text-sm font-medium text-purple-800 mb-1">
                                  📋 Akun Telah Dikirim
                                </h4>
                                <p className="text-sm text-purple-700">
                                  Penjual telah mengirim data akun. Silakan periksa dan konfirmasi penerimaan.
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        {item.status === 'DIKONFIRMASI_PEMBELI' && (
                          <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
                            <div className="flex items-start">
                              <ShieldCheckIcon className="h-5 w-5 text-indigo-600 mt-0.5 mr-3" />
                              <div>
                                <h4 className="text-sm font-medium text-indigo-800 mb-1">
                                  🛡️ Menunggu Release Dana
                                </h4>
                                <p className="text-sm text-indigo-700">
                                  Anda telah mengkonfirmasi penerimaan. Dana masih ditahan dan akan dilepas oleh admin.
                                </p>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="flex items-start">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-green-700">
                                  Transaksi telah selesai. Dana telah dilepas ke penjual.
                                </p>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="flex items-start">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-red-700">
                                  Transaksi sedang dalam proses sengketa. Admin akan meninjau dan memberikan keputusan.
                                </p>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="flex flex-wrap gap-3">
                        ...
                        {(() => {
                          ...
                          return hasData && validStatus && (
                            <button
                              ...
                              className="flex-1 sm:flex-none inline-flex items-center justify-center px-4 py-2 border border-green-300 text-sm font-medium rounded-lg text-green-700 bg-green-50 hover:bg-green-100 transition-colors"
                            >
                        ...
                        {item.status === 'DIKIRIM' && (
                          <button
                            ...
                            className="flex-1 sm:flex-none inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-green-600 hover:bg-green-700 transition-colors"
                          >
                        ...
                        {canCreateDispute(item) && (
                          <button
                            ...
                            className="flex-1 sm:flex-none inline-flex items-center justify-center px-4 py-2 border border-red-300 text-sm font-medium rounded-lg text-red-700 bg-red-50 hover:bg-red-100 transition-colors"
                          >
                        ...
                        <button
                          ...
                          className="flex-1 sm:flex-none inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-colors"
                        >
